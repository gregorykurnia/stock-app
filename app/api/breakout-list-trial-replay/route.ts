...
export async function GET(req: NextRequest) {
  ...
  return NextResponse.json({
    ...
    outcomeBasis: "entered episodes: +20% before -12% using future daily closes from assumed next-session fill",
    eligibleDates: replay.eligibleDates,
    rawQualifyingDayCount: replay.rawQualifyingDayCount,
    episodeCount: replay.episodeCount,
    signalCount: replay.episodeCount,
    rawQualifyingDays: replay.rawQualifyingDays,
    episodes: replay.episodes.slice(0, MAX_RETURNED_SIGNALS),
