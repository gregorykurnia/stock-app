...
type SortKey =
  ...
  | "low1yr" | "daysSinceLow1yr" | "distLow1yr" | "cagrLow1yr" | "rsi" | "diPlus" | "diMinus" | "adx" | "shortFloat" | "adv" | "relVolume" | "earnings" | "coiledBase" | "recentBreakout" | "strongUptrend" | "stableLongTerm" | "parabolicRecovery";
  ...
  function exportCsv() {
    ...
    const data = sortedRows.map((r) => {
      ...
      return [
        ...
        [r.coiledBase ? "Limited Upside" : "", r.recentBreakout ? "Recent Breakout" : "", r.strongUptrend ? "Strong Uptrend" : "", r.stableLongTerm ? "Stable Long Term" : "", r.parabolicRecovery ? "Parabolic Recovery" : ""].filter(Boolean).join(" / "),
              ...
              <tr key={r.ticker} className="hover:bg-gray-50">
                ...
                <td className="px-3 py-2">
                  <div className="flex flex-col gap-1 items-start">
                    ...
                    {!r.coiledBase && !r.recentBreakout && !r.strongUptrend && !r.stableLongTerm && !r.parabolicRecovery && dash}
                  </div>
                </td>
